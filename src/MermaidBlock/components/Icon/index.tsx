import { DownloadIcon, CopyIcon } from 'ds-markdown';

const DownScaleIcon: React.FC<{ size: number }> = ({ size = '1em' }) => {
  return (
...
const UpScaleIcon: React.FC<{ size: number }> = ({ size = '1em' }) => {
  return (
    <svg width={size} height={size} viewBox={`0 0 24 24`} fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
...
const FullScreenIcon: React.FC<{ size: number }> = ({ size = '1em' }) => {
  return (
...
const CloseIcon: React.FC<{ size: number }> = ({ size = '1em' }) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} fill="none" viewBox="0 0 24 24">
      <path
        fill="currentColor"
